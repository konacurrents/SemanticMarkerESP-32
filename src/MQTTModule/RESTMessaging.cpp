...
#include "RESTMessaging.h"
#ifdef USE_REST_MESSAGING

//! @see https://github.com/konacurrents/ESP_IOT/issues/285

#include <WiFiClientSecure.h>

const char *_SemanticMarker_org_root_ca =
"-----BEGIN CERTIFICATE-----\n" \
...
//! server name we will be calling.. with the cert above
const char *_SemanticMarkerServer = "SemanticMarker.org";


//! setup the secure network
...
void sendSecureRESTCall(String message)
{
    ...
    SerialDebug.print("sendSecureRESTCall: ");
    ...
    else
    {
       ...
       // _secureClient.println("GET /bot/feed/scott@konacurrents.com/id0gwatch HTTP/1.1");
        ...
        _secureClient.print(message.c_str());
        _secureClient.println(" HTTP/1.1");
         */

        _secureClient.println("Host: semanticMarker.org");
